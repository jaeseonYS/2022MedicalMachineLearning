...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/endoscopy.yaml', help='datasets.yaml path')
    ...
    parser.add_argument('--project', default=ROOT / 'runs/endoscopy', help='save to project/name')
